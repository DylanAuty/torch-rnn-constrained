-- trainFromPairedSamples.lua
-- Modification of train.lua
-- Enables training to work with a series of examples
-- For the time being, assumes data is in following format within a .h5 file:
-- data: {
-- 		train: ...
-- 		validate: ...
-- 		test: { 
...
-- }
-- 	 
-- Network may or may not get reset at the end of presenting every example.			 			
-- Modification: Dylan Auty 1/6/2016
...
-- Dataset options
-- h5 file contains the encoded data
-- json file contains the idx_to_token and token_to_idx keys
