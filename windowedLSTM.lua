--[[ windowedLSTM.lua
-- A modified LSTM cell, which includes the windowing cell of Graves et. Al 2014
-- Intended to be used for the first layer of a network ONLY.
-- 
-- Modification: Dylan Auty 3/6/2016
--]]
